...
//				}
			...
			case CMD_SET_IO_STATUS:  //0x34
			{
				...
				Set_Out_IO(ucIO_ID, (GPIO_PinState)lValue);
			}
			break;
			case CMD_GET_INPUT_IO_STATUS:
			{
				Get_In_IO_One(tSubProcess.uParam[0].ucData[0], &s_uResult.ucData[0]);
			
			}
			break;
			case CMD_GET_OUTPUT_IO_STATUS:
			{
				Get_Out_IO_One(tSubProcess.uParam[0].ucData[0], &s_uResult.ucData[0]);
			}
			break;
