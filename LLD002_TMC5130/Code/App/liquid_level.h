...
#define  PLLD_STAGE_AIR_MOMENT         5u        //吸液时空吸
...
#define  PLLD_LIQUL                    0x20        //开启气压探测液面
...
struct tagAirSenPara
{
	...
	int16_t    RakeRatio4Max;                    //吸液气压上限
	int16_t    RakeRatio4Min;                    //吸液气压下限
...
//	uint8_t    sig1_cnt_6;                       //信号1计数
	uint8_t    sig1_cnt_7;                       //信号1计数
	uint8_t    sig1_cnt_8;                       //信号1计数	
	uint8_t    sig1_cnt_9;                       //信号1计数
//	uint8_t    sig1_cnt_10;                      //信号1计数
...
//	uint8_t    AbsState1_6;                      //吸液状态1
	uint8_t    AbsState1_7;                      //吸液状态1
	uint8_t    AbsState1_8;                      //吸液状态1
	uint8_t    AbsState1_9;                      //吸液状态1
//	uint8_t    AbsState1_10;                     //吸液状态1
